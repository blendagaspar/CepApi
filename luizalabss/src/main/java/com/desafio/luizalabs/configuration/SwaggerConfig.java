package com.desafio.luizalabs.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		.basePackage("com.desafio.luizalabs.controller"))
	...
	private static Contact contact() {
		...
		return new Contact("Blenda Gaspar", 
				"https://github.com/blendagaspar", 
				"blendagaspar@hotmail.com");
	}
